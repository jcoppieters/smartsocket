...
class GarageDoor extends accessory_1.Accessory {
    ...
    attachServices(garageDoor) {
        garageDoor.getCharacteristic(this.homebridge.Characteristic.TargetDoorState)
            .on('get', this.getTargetDoorState.bind(this))
            .on('set', this.setDoorState.bind(this));
        garageDoor.getCharacteristic(this.homebridge.Characteristic.CurrentDoorState)
...
//# sourceMappingURL=garagedoor copy.js.map