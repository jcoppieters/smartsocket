...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, menuCtrl, system) {
...
/* harmony import */ var _system_system__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./system/system */ "./src/app/system/system.ts");
...
/* harmony import */ var _rendering_updown__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../rendering/updown */ "./src/app/rendering/updown.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TemperaturPipe", function() { return TemperaturPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
// Johan, 11/11/2020


let TemperaturPipe = class TemperaturPipe {
    transform(value) {
...
TemperaturPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _translations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./translations */ "./src/app/core/translations.ts");
...
function Translate(value, system) {
    ...
    const tran = _translations__WEBPACK_IMPORTED_MODULE_3__["translations"][lan][value];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DimmerControl", function() { return DimmerControl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
DimmerControl = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'dimmer',
        inputs: ['service'],
        template: `
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoodControl", function() { return MoodControl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
let MoodControl = class MoodControl {
...
MoodControl.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"] }
];
MoodControl = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'mood',
        inputs: ['service'],
        template: `
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TemperatureControl", function() { return TemperatureControl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
TemperatureControl = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  `,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./temperature.scss */ "./src/app/rendering/temperature.scss")).default]
    })
    /*
      unit.status => 0=idle, 1=heating, 2=cooling
      unit.preset => 0=sun, 1=half sun, 2=moon, 3=half moon, -1=off
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpDownControl", function() { return UpDownControl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _system_protocol__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../system/protocol */ "./src/app/system/protocol.ts");



let UpDownControl = class UpDownControl {
    state() {
...
UpDownControl = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'updown',
        inputs: ['service'],
        template: `
  ...
  `,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./updown.scss */ "./src/app/rendering/updown.scss")).default]
    })
], UpDownControl);
...
class Master extends _logger__WEBPACK_IMPORTED_MODULE_3__["Logger"] {
    ...
    */
    constructor(system, config, toastCtrl) {
        super("master", system.debug);
        this.toastCtrl = toastCtrl;
        this.resolveLogin = null;
        this.Q = new _Q__WEBPACK_IMPORTED_MODULE_4__["Q"](system.logger);
        // save my eco system
        this.system = system;
        // save this masters config settings
        this.config = _types__WEBPACK_IMPORTED_MODULE_2__["Sanitizers"].masterConfig(config);
    ...
    close() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.isOpen) {
                const message = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildDisconnect();
                try {
    ...
    send(message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return this.Q.exec(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (!this.isOpen) {
                    yield this.open();
                    if (!(yield this.login())) {
                        return _types__WEBPACK_IMPORTED_MODULE_2__["WriteError"].writeFatal;
                    }
                }
                return _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].write(this.socket, message);
            }));
        });
    }
    handleData(message) {
    ...
    processData() {
        ...
        const next = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].nextMessage(this.buffer);
    ...
    receiveNodeInfo(message) {
        const nodeInfo = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].makeNodeInfo(message);
    ...
    receiveUnitInfo(message) {
        const unitInfo = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].makeUnitInfo(message);
    ...
    fetchDbInfo() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildDBInfo());
                yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildRequestSchedule());
            }
            catch (err) {
    ...
    fetchNode(nodeInx) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const message = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildNodeInfo(nodeInx);
            try {
                yield this.send(message);
            }
            catch (err) {
    ...
    fetchUnit(node, unitInx) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const message = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildUnitInfo(node, unitInx);
            try {
    ...
    requestUnitStatus(unit) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const message = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildRequestUnitStatus(unit.node, unit);
    ...
    setUnitStatus(unit, value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const params = _protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildSetCmd(unit.node, unit, value);
            if (params.cmd) {
    ...
    setPreset(unit, preset, temp) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildSetPreset(unit.node, unit, preset, temp));
            this.info("set temp preset: " + preset + " of " + unit.node.getName() + "-" + unit.getName() + " to temp " + temp);
        });
    }
    selectPreset(unit, preset) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildSelectPreset(unit.node, unit, preset));
            this.info("set temp preset of " + unit.node.getName() + "-" + unit.getName() + " to: " + preset);
        });
    }
    setSchedule() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildSendSchedule(this.schedule));
            this.info("set schedule to week nr: " + this.schedule);
        });
    }
    setTempOnOff(unit, on) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildSensorOnOff(unit.node, unit, on));
            this.info("turn temp sensor of " + unit.node.getName() + "-" + unit.getName() + ": " + (on ? "on" : "off"));
        });
    }
    doIncDecPreset(unit, inc) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.send(_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"].buildIncDecPreset(unit.node, unit, inc));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types */ "./src/app/system/types.ts");
...
const Protocol = {
    ...
    nextMessage: function (buffer) {
        // pre return result
        const nextRec = { rest: buffer, isStatus: false, message: null, cmd: 0, raw: "" };
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _master__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./master */ "./src/app/system/master.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./types */ "./src/app/system/types.ts");
/* harmony import */ var _protocol__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./protocol */ "./src/app/system/protocol.ts");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./logger */ "./src/app/system/logger.ts");
...
let System = class System extends _logger__WEBPACK_IMPORTED_MODULE_5__["Logger"] {
    constructor(toastCtrl) {
        super("system", true);
        this.toastCtrl = toastCtrl;
        this.backup = null;
  ...
  */
    ...
    doBackup() {
        ...
        if (master) {
            _protocol__WEBPACK_IMPORTED_MODULE_4__["Protocol"].write(master.getSocket(), '[9,B-' + master.getAddress() + '-system:' +
    ...
    read(type) {
        ...
        // sanitize the config
        const temp = _types__WEBPACK_IMPORTED_MODULE_3__["Sanitizers"][type](config);
    ...
    writeScenes() {
        ...
        const sceneConfigs = _types__WEBPACK_IMPORTED_MODULE_3__["Sanitizers"].scenes(this.scenes);
        this.write("scenes", sceneConfigs);
    }
};
System.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ToastController"] }
];
System = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kEmptyGroup", function() { return kEmptyGroup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WriteError", function() { return WriteError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kEmptyCommRecord", function() { return kEmptyCommRecord; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Sanitizers", function() { return Sanitizers; });
...
;
const kEmptyCommRecord = { status: false, cmd: -1, message: [-1, 0, 0], rest: '' };
////////////////
// Sanitizers //
////////////////
const Sanitizers = {
    ...
    sceneConfig: function (config) {
        ...
        const newConfig = Object.assign({}, kEmptyScene);
...
module.exports = __webpack_require__(/*! /Users/johan/Library/Mobile Documents/com~apple~CloudDocs/Projects/Duotecno/smartsystem/src/main.ts */"./src/main.ts");
